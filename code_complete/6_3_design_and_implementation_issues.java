...
// 3) prefer polymorphism to extensive type checking (i.e. repeated swith statement)
//
// example: a swith statement that should be replaced by polymorphism
//          (same type of behaviors, i.e. implement same interface)
//
// (bad design: adding a new shapes needs to modify this as well)
switch ( shape.type ) {
    case Shape_Circle:
        shape.DrawCircle();
        break;
...
// (good design)
shape.Draw();             // called regardless of whether the shape is a circle or a square
